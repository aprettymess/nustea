...
import 'package:nustea/features/post/controller/post_controller.dart';
...
class PostCard extends ConsumerWidget {
  ...
  void navigateToCommunity(BuildContext context) {
    Routemaster.of(context).push('/n/${post.communityName}');
  }
                          ...
                          children: [
                                  ...
                                  children: [
                                    GestureDetector(
                                      ...
                                      child: CachedImageUtils.profileAvatar(
                                        imageUrl: post.communityProfilePic,
                                        radius: 16,
                                      ),
                                    ),
                                    Padding(
                            ...
                            if (isTypeImage)
                              SizedBox(
                                ...
                                child: CachedImageUtils.cachedImage(
                                  imageUrl: post.link!,
